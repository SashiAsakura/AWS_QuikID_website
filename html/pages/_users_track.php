...
$products = array('-1' => 'Any', '1' => 'Yes', '0' => 'No');
...
$frm = file_get_contents('pages/_users_track.frm');
$opts = '';
...
if ($enddate!='')$enddate = convertFromDateToUnixTimestamp($enddate);
 ...
 $rowsperpage = GetMarketingUserListCountFor(-1,$company,$email,$stdate,$enddate,$product);
...
$no = $first+1;
$articles = GetMarketingUserListForSource($first,$rowsperpage,-1,$company,$email,$stdate,$enddate,$product);
...
//print_r($articles);
$content.= 'Total downloads: '.GetMarketingUserListCountFor(-1,$company,$email,$stdate,$enddate,$product);
...
$totalpages = (int)((GetMarketingUserListCountFor(-1,$company,$email,$stdate,$enddate,$product)+$rowsperpage-1)/$rowsperpage);
